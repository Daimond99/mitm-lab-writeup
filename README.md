...
> **⚠️ Authorized lab use only.** ทุกขั้นตอนทำในเครือข่ายทดลองแบบปิด (isolated VMware lab, subnet `192.168.174.0/24`) เครื่องเหยื่อเป็น Windows VM ของผู้ทดลองเอง ไม่มีการโจมตีระบบจริง เว็บไซต์จริง หรือผู้ใช้จริงใด ๆ เผยแพร่เพื่อการศึกษาเท่านั้น การนำเทคนิคนี้ไปใช้กับระบบที่ไม่ได้รับอนุญาตเป็นความผิดตามกฎหมาย
>
...
![Lab1 · caplet config](images/lab1_01_caplet.png)
